  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-gray-100 bg-white shadow-default sm:right-0 sm:w-80 ${
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          ...
          <li>
            ...
            >
              <p className="text-sm">
                <span className="text-cyan-600">There are many variations</span>{' '}
          ...
          <li>
            <Link
              className="flex flex-col gap-2.5 border-t border-gray-10 px-4.5 py-3 hover:bg-gray-200"
              href="#"
            >
              <p className="text-sm">
                <span className="text-cyan-600">There are many variations</span>{' '}
